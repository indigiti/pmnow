...
<div class="personalization-strip"><span><b>For You</b><?= $homePrefs?' · '.pm_e(implode(' · ',array_slice($homePrefs,0,3))):' · Pune' ?></span><a href="<?=pm_e(pm_url('/profile'))?>">Tune My Pune</a></div>
