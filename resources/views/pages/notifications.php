<div class="phone"><div class="scroll withnav">
<header class="page-head"><a class="iconbtn" href="<?=pm_e(pm_url('/'))?>">←</a><h1>Notifications</h1><div class="spacer"></div></header>
<section class="sect"><div class="secttitle"><h2>Your updates</h2><span class="link"><?= count($notifications) ?></span></div>
