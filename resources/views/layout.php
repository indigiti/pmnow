  ...
  <aside class="desktop-context" aria-label="Pune context">
    <div class="context-card">
      ...
      <div class="context-links">
        <a href="<?=pm_e(pm_url('/explore?q=traffic'))?>"><span>Traffic</span><?=pm_icon('arrow-right','sm')?></a>
        <a href="<?=pm_e(pm_url('/explore?q=civic'))?>"><span>Civic</span><?=pm_icon('arrow-right','sm')?></a>
        <a href="<?=pm_e(pm_url('/explore?q=events'))?>"><span>What’s on</span><?=pm_icon('arrow-right','sm')?></a>
      </div>
    </div>
    <div class="context-card">
      <h3>My Pune</h3>
      <p>Save stories and follow live or developing coverage to build your personal local-news stream.</p>
      <div class="context-links"><a href="<?=pm_e(pm_url('/profile'))?>"><span>Open My Pune</span><?=pm_icon('arrow-right','sm')?></a></div>
    </div>
  </aside>
<?php endif; ?>
</div>
