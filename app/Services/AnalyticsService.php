...
final class AnalyticsService
{
    private const EVENTS=[
        ...
        'share','bookmark','follow','search','notification_open','reel_view','gallery_complete','preference_update','near_you_open','notification_preferences_update','push_subscribe','digest_delivered','notification_open','utility_follow','utility_open'
    ];
