...
final class AdminPageController
{
    ...
    public function community():never{$u=$this->requireUser();$this->page('admin/community',['adminUser'=>$u,'communityQueue'=>$this->community?->moderationQueue()??[],'communityReports'=>$this->community?->reports()??[]]);}
    public function events():never{$u=$this->requireUser();$this->page('admin/events',['adminUser'=>$u,'events'=>$this->events?->upcoming(null,100)??[]]);}
