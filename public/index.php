...
$storyService=new StoryService($storyRepo,$mediaRepo,$store);$userService=new UserStateService($userRepo);$analyticsService=new AnalyticsService($store);
