...
$page=new PageController($view,$storyService,$userService,$notificationService,$store,$seoService,$personalizationService,$utilityService);$api=new ApiController($storyService,$userService,$store,$runtime,$config,$searchService,$notificationService,$analyticsService,$personalizationService,$pushSubscriptionService);$utilityApi=new UtilityApiController($utilityService,$userService,$analyticsService);$discovery=new DiscoveryController($storyRepo,$storyService,$store,$distributionService);$hub=new HubApiController($sourceService,$hubService,$python,$authService);$adminPage=new AdminPageController($view,$authService,$editorialService,$sourceService,$jobRepo,$store,$errors,$healthService,$analyticsService,$utilityService);$newsroom=new NewsroomApiController($authService,$editorialService,$jobRepo,$schedulerService,$workerService,$searchService,$notificationService,$userService,$errors,$healthService,$distributionService,$utilityService);$router=new Router();
